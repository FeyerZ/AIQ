...
def ask_chatgpt(request):
    ...
    prompt_2 = (
        ...
        f"You know everything, you love {interest_points}. Don't just say fact1 and fact2, give me an actual fact. What are the 2 most interesting facts about {interest_points}? Respond only with the json file, don't say anything else and have 9 entries. "
    )
